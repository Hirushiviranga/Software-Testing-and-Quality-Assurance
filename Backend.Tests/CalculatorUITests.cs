...
namespace Backend.Tests
{
    ...
    public class CalculatorUITests
    {
        ...
        public void OneTimeSetup()
        {
            ...
            // options.AddArgument("--headless"); // Uncomment if you want headless
        ...
        public void HistoryPage_UI()
        {
            ...
            // Wait for history item that matches "2 + 3 = 5"
            var waitLong = new WebDriverWait(_driver, TimeSpan.FromSeconds(20));
            var historyItem = waitLong.Until(d =>
            {
                var items = d.FindElements(By.CssSelector("li.history-item"));
                foreach (var li in items)
                {
                    if (li.Text.Replace(" ", "").Contains("2+3=5")) // normalize spaces
                        return li;
                }
                return null;
            });
...
namespace Backend.Tests
{
    ...
    public class CalculatorUITests
    {
        ...
        public void OneTimeSetup()
        {
            ...
            // ✅ Detect environment to choose headless or normal
            // If running in CI (Linux), use headless
...
namespace Backend.Tests
{
    ...
    public class CalculatorUITests
    {
        ...
        [Test]
        public void MultiplyTwoNumbers_UI() => RunCalculatorTest("6", "7", "multiply", "Result: 42");

        [Test]
        public void DivideTwoNumbers_UI() => RunCalculatorTest("20", "4", "divide", "Result: 5");
        ...
        public void HistoryPage_UI()
        {
            ...
            var historyItem = waitLong.Until(d =>
            {
                foreach (var li in d.FindElements(By.CssSelector("li.history-item")))
                {
